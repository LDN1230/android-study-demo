...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
        ...
        Observable<PreviewObj> observableGetImageUrl = Observable.create(new ObservableOnSubscribe<PreviewObj>() {
            ...
            public void subscribe(ObservableEmitter<PreviewObj> observableEmitter) throws Exception {
                ...
                if(conn.getResponseCode() == 200){
                    Log.d("RyclerAdapter Observa", Thread.currentThread().getName().toString());
        ...
        DisposableObserver<PreviewObj> disposableObserver = new DisposableObserver<PreviewObj>() {
            ...
            public void onNext(final PreviewObj previewObj) {
                ...
                new Thread() {
                    ...
                    public void run() {
                        try {
                            Log.d("RyclerAdapter Observer", Thread.currentThread().getName().toString());
                            //获取封面的图片
    ...
    //通过url得到bitmap文件
    private static Bitmap getBitmap(String path) throws IOException, ProtocolException {
    ...
    //裁剪图片
    private static ArrayList<Bitmap> cutBitmap(Bitmap bitmap, int img_x_len, int total_len, int img_x_size, int img_y_size){
