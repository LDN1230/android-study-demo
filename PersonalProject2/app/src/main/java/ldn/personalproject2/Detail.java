...
public class Detail extends AppCompatActivity {
    ...
    private int change;//记录favorite属性改变次数
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        food_if_favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(star_empty){
                    food_if_favorite.setImageDrawable(getResources().getDrawable(R.mipmap.empty_star, null));
                    star_empty = false;
                }else{
                    food_if_favorite.setImageDrawable(getResources().getDrawable(R.mipmap.full_star, null));
                    star_empty = true;
                }
            }
        });
