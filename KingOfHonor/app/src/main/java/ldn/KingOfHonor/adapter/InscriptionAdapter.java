...
public class InscriptionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.level.setText(String.valueOf(list.get(position).getLevel()) + "级");
        Map<String, Double> pro = list.get(position).getProperty();
        if(pro.size() == 1) {
        ...
        viewHolder.pic.setImageResource(list.get(position).getImage());
        // 将这个处理好的view返回
        return convertView;
    }
