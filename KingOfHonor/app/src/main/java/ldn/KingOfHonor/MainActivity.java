...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * @description 从Raw资源读取装备信息
     * @return String[]
     * @author LDN
     * @time 2020/5/31 10:27
     */
    ...
    /**
     * @description 完成初始化，往数据库写入初始数据
     * @author LDN
     * @time 2020/5/31 10:48
     */
     ...
     * @time 2020/5/31 10:48
     */
    private void initialAddIncription() {
    ...
    /**
     * @description 初始化装备，从txt文件获取装备信息并创建到数据表中
     * @author LDN
     * @time 2020/5/31 10:38
     */
    private void initialAddEquipment() {
        // 先删除数据表中装备的信息
        heroSQLiteHelper.deleteAllEquipments();
        String[] equip = readEquipFromRaw();
    ...
    /**
     * @description 初始化往数据库添加英雄
     * @author LDN
     * @time 2020/5/31 10:19
     */
    private void initialAddHero() {
        // 先删除数据库中英雄的信息
        ...
        heroSQLiteHelper.addHero(new Hero("橘右京", "android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.juyoujing, "神梦一刀", "刺客" , 5, 6, 5 ,5,
                "android.resource://ldn.KingOfHonor/" + R.raw.juyoujing,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.juyoujing_icon, true,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.juyoujing1, "秘剑胧刀 冷却值：5消耗：0\n" +
                "\n" +
                "被动：橘右京将下一次普攻将进行一次强力拔刀斩，对前方敌人造成130%物理加成物理伤害并减少50%移动速度，持续2秒；拔刀斩每5秒可准备1次；对处于攻击边缘的敌人将承受50%的额外伤害.",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.juyoujing2, "燕返 冷却值：7消耗：0\n" +
                "\n" +
                "橘右京跃向后方，同时向前方挥刀，对附近的敌人造成200/240/280/320/360/400（+145%物理加成）点物理伤害，若成功命中一名敌方英雄，可激活二段使用",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.juyoujing3, "居合 冷却值：10/9.5/9/8.5/8/7.5消耗：0\n" +
                "\n" +
                "橘右京向指定方向快速拔刀，对路径上的第一个敌人造成330/375/420/465/510/555（+212%物理加成）点物理伤害，对路上的其余敌人造成的伤害将衰减50%,并将路径末端的敌人眩晕0.75秒",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.juyoujing4, "细雪 冷却值：12/11.5/11消耗：0\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("李白","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.libai,"青莲剑仙", "刺客", 4, 7, 6, 9,
                "android.resource://ldn.KingOfHonor/" + R.raw.libai,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.libai_icon, true,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.libai1, "侠客行 冷却值：0消耗：0\n" +
                "\n" +
                "被动：李白使用普通攻击攻击敌人时，会积累1道剑气，持续3秒；积累4道剑气后进入侠客行状态，增加30点物理攻击力并解除青莲剑歌的封印，持续5秒；攻击建筑不会积累剑气",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.libai2, "将进酒 冷却值：12/10.6/9.2/7.8/6.4/5消耗：80\n" +
                "\n" +
                "李白可用醉剑式向指定方向连续突进2次，对路径上的敌人造成300/350/400/450/500/550（+110%物理加成）点物理伤害并且造成晕眩0.5秒；第三次释放会回到原地；每次释放间隔不能超过5秒",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.libai3,"神来之笔 冷却值：12/11.6/11.2/10.8/10.4/10消耗：60\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.libai4,"青莲剑歌 冷却值：12消耗：120\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("凯","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.kai,"破灭刀锋", "战士", 7,7, 4, 2,
                null,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.kai_icon, false,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.kai1, "修罗之魂 冷却值：0消耗：0\n" +
                "\n" +
                "被动：铠拥有精湛的战斗技巧，当铠的普通攻击和极刃风暴只命中了一个目标时将会额外造成50%伤害。",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.kai2, "回旋之刃 冷却值：10消耗：60\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.kai3,"极刃风暴 冷却值：6消耗：50\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.kai4,"不灭魔躯 冷却值：60/55/50消耗：120\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("嬴政","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.yingzheng,"王者独尊", "法师", 3, 4, 9, 6,
                "android.resource://ldn.KingOfHonor/" + R.raw.yingzheng,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.yingzheng_icon, false,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.yingzheng1, "王者审判 冷却值：0消耗：0\n" +
                "\n" +
                "被动：嬴政的普通攻击可以击穿目标，并造成70（+100%物理加成）（+30%法术加成）点法术伤害；攻击机关时会衰减50%的伤害",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.yingzheng2, "王者惩戒 冷却值：8消耗：100\n" +
                "\n" +
                "嬴政在指定目标区域召唤黄金剑阵，持续2.5秒，每0.5秒对范围内的敌人造成100/120/140/160/180/200（+27%法术加成）点法术伤害；范围内敌人会减少10%移动速度，持续1秒，最多叠加5层",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.yingzheng3,"王者守御 冷却值：12/11/10/9/8/7消耗：40\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.yingzheng4,"至尊王权 冷却值：30消耗：150\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("诸葛亮","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.zhugeliang,"绝代智谋", "法师", 3, 1, 8, 6,
                "android.resource://ldn.KingOfHonor/" + R.raw.zhugeliang,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhugeliang_icon, true,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhugeliang1, "策谋之刻 冷却值：0消耗：0\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhugeliang2, "东风破袭 冷却值：8/7.4/6.8/6.2/5.6/5消耗：60\n" +
                "\n" +
                "诸葛亮指定方向发射三颗法球，对路径上的敌人造成500/560/620/680/740/800（+75%法术加成）点法术伤害，如果多颗法球命中同一目标时，从第二颗法球开始将只造成30%伤害；每颗法球能触发1次谋略刻印",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhugeliang3,"时空穿梭 冷却值：2消耗：50\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhugeliang4,"元气弹 冷却值：35/30/25消耗：120\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("后羿","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.houyi,"半神之弓", "射手", 3, 8, 4, 3,
                "android.resource://ldn.KingOfHonor/" + R.raw.houyi,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.houyi_icon, false,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.houyi1, "惩戒射击 冷却值：0消耗：0\n" +
                "\n" +
                "后羿的普攻命中敌人后增加自身10%攻击速度，可叠加至多3层。当攻速加成叠加到3层时，后羿的普攻将射出3支箭矢，每支箭矢造成原伤害的40%，强化持续3秒。（期间每次命中刷新持续时间）",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.houyi2, "多重箭矢 冷却值：10消耗：60\n" +
                "\n" +
                "后羿强化自身攻击，每次攻击造成100/120/140/160/180/200（+80%物理加成）点物理伤害（若触发惩戒射击则每支箭矢造成原伤害的40%）并对面前区域内另外2名敌人造成50%伤害，该效果持续5秒",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.houyi3,"落日余晖 冷却值：8/7.4/6.8/6.2/5.6/5消耗：60\n" +
                "\n" +
                "后羿命令日炙塔对指定区域进行攻击，短暂时间后召唤一束激光打击指定位置。对命中的敌人造成240/280/320/360/400/440（+80%物理加成）点法术伤害和50%减速效果，持续2秒，被中心点命中的敌人将受到额外50%的伤害",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.houyi4,"灼日之矢 冷却值：45/40/35消耗：130\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("关羽","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.guanyu,"一骑当千", "战士", 6, 6, 6, 8,
                "android.resource://ldn.KingOfHonor/" + R.raw.guanyu,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.guanyu_icon, true,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.guanyu1, "一骑当千 冷却值：0消耗：0\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.guanyu2, "单刀赴会 冷却值：8/7.2/6.4/5.6/4.8/4消耗：0\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.guanyu3,"青龙偃月 冷却值：14消耗：0\n" +
                "\n" +
                "关羽清啸一声，解除自身控制效果并增加30％移动速度，持续2秒；冲锋姿态：关羽清啸一声，解除自身控制效果并向前跃击敌人将其击退，造成335/470/605/740/875/1010(+112％物理加成）点物理伤害",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.guanyu4,"刀锋铁骑 冷却值：70/60/50消耗：0\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("马可波罗","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.makeboluo,"远游之枪", "射手", 3, 6, 6, 5,
                "android.resource://ldn.KingOfHonor/" + R.raw.makeboluo,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.makeboluo_icon, false,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.makeboluo1, "连锁反应 冷却值：0消耗：0\n" +
                "\n" +
                "被动：马可波罗的普攻与技能伤害能够破坏目标的防御并回复50点能量，连续10次受到伤害后，目标每次受到马可波罗的伤害都会额外受到45（+15%物理加成）点真实伤害(该伤害可以暴击)，持续5秒",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.makeboluo2, "华丽左轮 冷却值：7/6.6/6.2/5.8/5.4/5消耗：70\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.makeboluo3,"漫游之枪 冷却值：5消耗：70\n" +
                "\n" +
                "马可波罗向指定方向闪烁，立即出现在目标位置；被动：马可波罗身边500范围内存在敌方英雄时，提升12%/14%/16%/18%/20%/22%的伤害和15%/18%/21%/24%/27%/30%移动速度",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.makeboluo4,"狂热弹幕 冷却值：50/45/40消耗：70\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("赵云","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.zhaoyun,"苍天翔龙", "战士", 6, 6, 6, 5,
                "android.resource://ldn.KingOfHonor/" + R.raw.zhaoyun,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhaoyun_icon, false,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhaoyun1, "龙鸣 冷却值：0消耗：0\n" +
                "\n" +
                "被动：赵云每损失3%最大生命值，就会获得减少1%所受到的伤害",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhaoyun2, "惊雷之龙 冷却值：7/6.4/5.8/5.2/4.6/4消耗：40\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhaoyun3,"破云之龙 冷却值：8/7.2/6.4/5.6/4.8/4消耗：50\n" +
                "\n" +
                "赵云向指定方向连续3次刺出龙枪，对指定方向敌人每次造成140/158/176/194/212/230（+60%物理加成）点物理伤害；每次命中英雄后回复35/39/43/47/51/55（+14%物理加成）点生命值",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.zhaoyun4,"天翔之龙 冷却值：18/15/12消耗：100\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("蔡文姬","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.caiwenji,"天籁弦音", "辅助", 5, 1, 8, 3,
                "android.resource://ldn.KingOfHonor/" + R.raw.caiwenji,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.caiwenji_icon, false,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.caiwenji1, "长歌行 冷却值：0消耗：0\n" +
                "\n" +
                "被动：当蔡文姬受到伤害时，自身会立刻增加70%持续衰减的移动速度，持续2秒，同时自身会每秒回复250（+50%法术加成）点生命值，持续2秒；长歌行每10秒只能触发一次",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.caiwenji2, "思无邪 冷却值：15/14.4/13.8/13.2/12.6/12消耗：100\n" +
                "\n" +
                "蔡文姬演奏乐曲，自身会增加20%移动速度，持续3秒，同时将为自身和周围的友方英雄每0.5秒恢复60/66/72/78/84/90（+20%法术加成）点生命值，持续3秒",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.caiwenji3,"胡笳乐 冷却值：9消耗：70\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.caiwenji4,"忘忧曲 冷却值：60消耗：120\n" +
                "\n" +
        ...
        heroSQLiteHelper.addHero(new Hero("刘邦","android.resource://" + getApplicationContext().getPackageName() + "/" +R.mipmap.liubang,"双面君主", "坦克", 8, 4, 6, 5,
                "android.resource://ldn.KingOfHonor/" + R.raw.liubang,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.liubang_icon, false,
                "android.resource://ldn.KingOfHonor/" + R.mipmap.liubang1, "君主野望 冷却值：0消耗：0\n" +
                "\n" +
                "被动：刘邦第三次普通攻击将附带最大生命值4-8%的法术伤害，增加幅度随英雄等级成长，该效果无法对机关造成伤害",
                "android.resource://ldn.KingOfHonor/" + R.mipmap.liubang2, "霸业之盾 冷却值：10消耗：75\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.liubang3,"双重恐吓 冷却值：10/9.6/9.2/8.8/8.4/8消耗：70\n" +
                "\n" +
                ...
                "android.resource://ldn.KingOfHonor/" + R.mipmap.liubang4,"统御战场 冷却值：70/65/60消耗：140\n" +
                "\n" +
